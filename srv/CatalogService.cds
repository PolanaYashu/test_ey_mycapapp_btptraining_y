...
using { yasaswini.db.master, yasaswini.db.transaction } from '../db/datamodel';
...
service CatalogService @(path: 'CatalogService') {
    ...
    entity POs @(
        ...
        *,
        ...
        @cds.odata.bindingparameter.name : '_yasaswini'
        @Common.SideEffects : {
                TargetProperties : ['_yasaswini/GROSS_AMOUNT']
            }  
        action boost();
    };
